        ...
        <div className="mb-6 md:mb-8">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              <MessageSquare className="w-6 md:w-8 h-6 md:h-8 text-[#174A8B] dark:text-blue-400" />
              <h1 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-gray-100">Chista AI</h1>
            </div>
